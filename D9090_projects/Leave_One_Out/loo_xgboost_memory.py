...
class Profiling_Model:
    ...
    Synopsis
    import loo_xgboost_memory
    def run_it();

    Description
    This is the main class of module loo_xgboost_memory. This class contains everything we need to run this model.
    ...
    def load_data(self):
        ...
        #self.validation = self.train_set
    ...
    def train_model(self,random_state=1,frac=1,n_estimators=400,max_depth=8):
