...
class Profiling_Model:
    ...
    Synopsis
    import loo_svr_memory
    def run_it();

    Description
    This is the main class of module loo_svr_memory. This class contains everything we need to run this model.
    ...
    def train_model(self,random_state=1,frac=1,C=100,gamma=0.01,epsilon=0.1):
