...
class Profiling_Model:
    ...
    Synopsis
    import sl_dnn_memory
    def run_it();

    Description
    This is the main class of module sl_dnn_memory. This class contains everything we need to run this model.
    ...
    def load_data(self):
        '''Load data from '../../splitted_data/D9090_split/'
        '''
    ...
    def train_model(self,random_state=1,frac=0.35,C=100,gamma=0.01,epsilon=0.1):
        ...
        es_callback = tf.keras.callbacks.EarlyStopping(monitor='val_mse',patience=10,mode='min',restore_best_weights=True)
